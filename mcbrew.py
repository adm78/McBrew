...
from mcbrewMainWindowGUI import Ui_mcbrewMainWindow


class DesignerMainWindow(QtGui.QMainWindow, Ui_mcbrewMainWindow):
    def __init__(self, parent = None):
        ...
        QtCore.QObject.connect(self.mcbrewactionOpen, 
                               QtCore.SIGNAL('triggered()'), 
                               self.select_file)

        QtCore.QObject.connect(self.mcbrewactionQuit, 
                               QtCore.SIGNAL('triggered()'), 
                               QtGui.qApp, QtCore.SLOT("quit()"))

        

        # QtCore.QObject.connect(self.mcbrewactionSineWave,
        #                        QtCore.SIGNAL('triggered()'), 
        #                        self.sine_wave_animation)

        # QtCore.QObject.connect(self.mcbrewfreqSlider,
