...
if not isWindows():
    ...
    if which(pyuic_exec) != None:
        pyuic_cmd = "pyuic mcbrewMainWindowGUI.ui > mcbrewMainWindowGUI.py"

    elif which(pyuic4_exec) != None:
        pyuic_cmd = "pyuic4 mcbrewMainWindowGUI.ui > mcbrewMainWindowGUI.py"
    else:
...
if not isWindows():
    if which("pyrcc4") != None:
        pyrcc_cmd = ("pyrcc4 " + os.path.join("GUIresources","mcbrewGUIresources.qrc") 
                     + " > mcbrewGUIresources_rc.py")
