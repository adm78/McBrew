...
'''This file is part of McBrew. It attempts to read the DB data generated
...
def startReader():
    ...
    rec_filenames = [join(db_path,'T_cache_1.txt')]
    rec_filenames.append(join(db_path,'T_cache_2.txt'))
